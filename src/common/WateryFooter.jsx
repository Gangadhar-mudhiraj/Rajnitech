...
const WateryDiv = ({ width = "100%", height = "100%" }) => {
    ...
    return (
        <div
            ref={containerRef}
            style={{ width, height }}
            className="relative bg-gradient-to-b from-[#1572B6] to-[#000428] z-0"
        >
            <motion.svg
                className="absolute -top-10 left-0 w-full h-[70px] z-[-1] pointer-events-none"
            ...
            {/* Increased number of floaters to 10 */}
